...
public:
	...
	void renderFaces(std::vector<Face>& faces, std::vector<glm::vec4>& finalVertices, bool isActiveModel = false, GLfloat scaleNormalLength = 0, bool isShowNormals = false, glm::vec3& modelColor = glm::vec3(0.8f, 0.8f, 0.8f), glm::vec3& normalsColor = glm::vec3(0.8f, 0.8f, 0.8f));
